 ...
 */
  [_DEFAULT] = KEYMAP_TRUE_HHKB( /* Basic QWERTY */
      ...
      KC_LSPO, ______,  KC_Z,    KC_X,    KC_C, KC_V, KC_B,   KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, MO(_FN), \
 ...
 */
  [_FN] = KEYMAP_TRUE_HHKB( /* Layer 1 */
      ...
      KC_CAPS, RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_VAD, RGB_HUI, RGB_HUD,  RGB_SAI,  RGB_SAD, KC_SLCK, KC_PAUS, KC_UP,  ______, ______,  \
